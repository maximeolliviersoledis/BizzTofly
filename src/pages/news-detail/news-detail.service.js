...
var NewsDetailsService = /** @class */ (function () {
    function NewsDetailsService(http, constService) {
        this.http = http;
        this.constService = constService;
    }
    NewsDetailsService.prototype.getNewsDetails = function (newsId) {
