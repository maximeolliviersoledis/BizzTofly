...
var OrderDetailsService = /** @class */ (function () {
    function OrderDetailsService(http, constService) {
        this.http = http;
        this.constService = constService;
    }
    OrderDetailsService.prototype.getOrderDetails = function (orderId) {
    ...
    OrderDetailsService.prototype.getRating = function (orderId) {
        var headers = new Headers();
        var authtoken = localStorage.getItem('token');
        headers.append('Authorization', authtoken);
