...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if(data.get("image") != null && (String)data.get("image") != null)
            bitmap = getBitmapfromUrl((String)data.get("image"));
     ...
     */
    private void sendNotification(String title, String messageBody, Map<String, String> data, Bitmap image) {
